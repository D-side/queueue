(defproject queueue "0.1.0-SNAPSHOT"
  ...
  :uberjar-name "queueue.jar"

  ;; Use `lein run` if you just want to start a HTTP server, without figwheel
  :main queueue.application
  ...
  :cljsbuild {:builds
              [{:id "app"
                ...
                :figwheel {:on-jsload "queueue.system/reset"}

                :compiler {:main cljs.user
                           :asset-path "js/compiled/out"
                           :output-to "dev-target/public/js/compiled/queueue.js"
               ...
               {:id "test"
                ...
                :compiler {:output-to "dev-target/public/js/compiled/testable.js"
                           :main queueue.test-runner
                           :optimizations :none}}

               {:id "min"
                :source-paths ["src/cljs" "src/cljc"]
                :jar true
                :compiler {:main queueue.system
                           :output-to "resources/public/js/compiled/queueue.js"
                           :output-dir "target"
                           :source-map-timestamp true
